...
class PassengerFlightsControllerTest < ActionController::TestCase
  ...
  test "should create passenger_flight" do
    assert_difference('PassengerFlight.count') do
      post :create, passenger_flight: { asiento: @passenger_flight.asiento, clase: @passenger_flight.clase, flight_id: @passenger_flight.flight_id, passenger_id: @passenger_flight.passenger_id }
    end
  ...
  test "should update passenger_flight" do
    patch :update, id: @passenger_flight, passenger_flight: { asiento: @passenger_flight.asiento, clase: @passenger_flight.clase, flight_id: @passenger_flight.flight_id, passenger_id: @passenger_flight.passenger_id }
    assert_redirected_to passenger_flight_path(assigns(:passenger_flight))
  end
