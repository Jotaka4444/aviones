...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { correo: @passenger.correo, descripcion: @passenger.descripcion, f_nacimiento: @passenger.f_nacimiento, nacionalidad: @passenger.nacionalidad, nombre: @passenger.nombre, rut: @passenger.rut, telefono: @passenger.telefono }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { correo: @passenger.correo, descripcion: @passenger.descripcion, f_nacimiento: @passenger.f_nacimiento, nacionalidad: @passenger.nacionalidad, nombre: @passenger.nombre, rut: @passenger.rut, telefono: @passenger.telefono }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
